...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-ORVZZZGG.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-QIK3V7XI.js").then((mod) => ({
          default: mod.App
        })),
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-AWMRJZMP.js");
...
//# sourceMappingURL=chunk-REYACF3O.js.map
